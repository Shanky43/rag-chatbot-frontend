...
//         title: session.title || session.name || `Chat ${(session.sessionId || session.id || '').slice(-6) || index + 1}`,
...
//   // FIXED: Don't add user message manually - let socket handler do it
//   // Send message via socket if connected
//   if (socket && isConnected) {
//     socket.sendMessage(messageText, sessionId);
//   } else {
//     // ONLY for REST API fallback, add messages manually
//     const userMessage = {
